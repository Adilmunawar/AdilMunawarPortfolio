...
const AboutSection = () => {
  ...
  return <section id="about" className="min-h-screen py-20 px-4">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                <p>
                  <strong className="text-white">I am a passionate and results-driven developer</strong> with extensive experience in frontend development, backend systems, and mobile/web app integration.
                </p>
                <p>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {frontendSkills.map((skill, index) => <Card key={index} className="p-4 bg-cyber-gray/20 border-cyber-cyan/20 hover:border-cyber-cyan/50 transition-all duration-300 hover:scale-105">
                    <div className="text-center">
                      <div className="mb-2 flex justify-center">
                        <img src={skill.image} alt={skill.name} className="w-8 h-8" loading="lazy" />
                      </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {backendSkills.map((skill, index) => <Card key={index} className="p-4 bg-cyber-gray/20 border-cyber-cyan/20 hover:border-cyber-cyan/50 transition-all duration-300 hover:scale-105">
                    <div className="text-center">
                      <div className="mb-2 flex justify-center">
                        <img src={skill.image} alt={skill.name} className="w-8 h-8" loading="lazy" />
                      </div>
