...
const ContactSection = () => {
  ...
  const contactMethods = [{
    ...
    hoverColor: 'hover:from-blue-600/20 hover:to-indigo-500/20',
    ...
    hoverColor: 'hover:from-gray-600/20 hover:to-slate-600/20',
  ...
  const footerSocials = [{
    ...
    bgGradient: 'from-gray-600/15 to-slate-600/15',
    ...
    bgGradient: 'from-pink-500/15 to-purple-500/15',
  ...
  return (
    <section id="contact" className="min-h-screen py-20 px-4 relative overflow-hidden bg-gradient-to-b from-gray-900 to-cyber-dark">
      ...
      <div className="absolute inset-0 bg-cyber-dark/95"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Enhanced contact cards grid with dark theme */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          {contactMethods.map((method, index) => (
            <Card 
              key={index} 
              className={`group relative p-8 bg-gray-900/60 backdrop-blur-xl border-2 ${method.borderColor} transition-all duration-700 hover:scale-105 cursor-pointer overflow-hidden animate-scale-in hover:shadow-2xl ${method.glowColor}`} 
            ...
            >
              ...
              <div className="relative text-center transform group-hover:translate-y-1 transition-transform duration-500">
                ...
                <div className={`w-20 h-20 rounded-2xl border-2 ${method.borderColor} bg-gray-800/60 backdrop-blur-sm flex items-center justify-center mx-auto mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-700 shadow-xl ${method.glowColor} ${hoveredCard === index ? 'animate-bounce' : ''}`}>
        ...
        <div className="relative">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 animate-fade-in-up" style={{ animationDelay: '1s' }}>
            ...
            {/* Enhanced social links with improved effects */}
            <div className="flex space-x-6">
              {footerSocials.map((social, index) => (
                <a 
                  ...
                  className={`group relative w-16 h-16 bg-gradient-to-br ${social.bgGradient} ${social.hoverGradient} rounded-2xl flex items-center justify-center transition-all duration-700 hover:scale-125 hover:rotate-[8deg] backdrop-blur-sm border-2 ${social.borderColor} hover:shadow-2xl ${social.shadowColor} ${social.color} overflow-visible`}
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <social.Icon size={24} className="transition-all duration-500 group-hover:scale-110 relative z-10" />
                  
                  {/* Enhanced animated notification dot with better positioning */}
                  ...
                  <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${social.bgGradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-pulse`}></div>
                  
                  {/* Enhanced ripple effect */}
                  <div className="absolute inset-0 rounded-2xl border-2 border-cyber-cyan/30 scale-90 group-hover:scale-110 opacity-0 group-hover:opacity-100 transition-all duration-500 animate-pulse"></div>
